...
///
/// Fix theo “Cách A” nhưng chống unbounded constraints do container cha (CustomActionSheetContainer) gây ra:
/// - Dùng LayoutBuilder để lấy maxHeight hữu hạn.
/// - Khóa chiều cao bằng SizedBox(height: constraints.maxHeight) trước khi dùng Column + Expanded.
/// - Bên trong: Expanded(ListView) để scroll chắc chắn.
class IdentityEditorSheet extends ConsumerStatefulWidget {
  const IdentityEditorSheet({
    super.key,
  ...
  @override
  ConsumerState<IdentityEditorSheet> createState() =>
      _IdentityEditorSheetState();
}

class _IdentityEditorSheetState extends ConsumerState<IdentityEditorSheet> {
        ...
        child: SafeAreaTopOnly(
          child: LayoutBuilder(
            builder: (context, constraints) {
              // Nếu constraints.maxHeight vẫn là Infinity (rất hiếm), fallback bằng 90% màn hình.
              ...
              return Padding(
                ...
                child: SizedBox(
                  height: maxH, // <-- khóa height để Expanded dùng được
                  child: Column(
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: _GenderChip(
                                    ...
                                    onTap: () =>
                                        _selectGender(PetGender.female),
                                  ),
                                ),
                            ...
                            // Chừa chỗ để list không bị che bởi button cố định
                          ],
                        ),
                      ),
                      // SizedBox(height: SC.sh(16)),
