...
class NannyWelcomeRemoteService {
  static Future<ServiceResponse<NannyWelcomeContent>>
  getWelcomeContent() async {
    ...
    try {
      final response = await ApiService.getNannyWelcome(token);
      ...
      final welcomeContent = NannyWelcomeContent.fromJson(data);
