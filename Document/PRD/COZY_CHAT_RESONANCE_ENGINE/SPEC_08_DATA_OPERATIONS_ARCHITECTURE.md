...
├────────────────────────────────────────┼───────────────────────────────┤
│ - GPS làm tròn (Client Geofencing)     │ - Bản tin văn hóa vùng miền   │
...
| :--- | :--- | :--- | :--- | :--- |
| **Tự động** | Tọa độ GPS & Vùng địa lý | Client GPS (Làm tròn 2 chữ số thập phân) | Hệ thống tự động lấy qua Geofencing trên App. | Thời gian thực (chạy ngầm). |
