...
```mermaid
graph TD
    Parent[Từ Khóa Mẹ: Lối sống chữa lành cùng thú cưng <br> Niche: Iyashikei & Pets]
    
    %% Cụm 1
    Parent --> C1(Cụm 1: Giải Mã Hành Vi <br> Dopamine & Đồng điệu)
    C1 --> C1_1["Bài 1: Tên Boss kỳ lạ"]
    C1_1 --> C1_2["Bài 2: Tại sao mèo cào sofa"]
    ...
    style C3 fill:#e3f2fd,stroke:#1565c0,stroke-width:1px
```
