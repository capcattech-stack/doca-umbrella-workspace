...
VALUES
  ...
  ('balo-cho-cho-meo-thoang-khi-luna', 'Balo cho chó mèo thoáng khí Luna', 'phu_kien', 0.0, NULL, 'https://s.shopee.vn/6Aj0fjxuS8', NULL, 'Chiếc phi thuyền thoáng đãng cùng cô/chú chu du khắp thế gian, ôm trọn tầm nhìn thế giới.'),
  ('chai-xit-khu-mui-diet-khuan-biopro', 'Chai xịt khử mùi, diệt khuẩn khu vực nuôi thú cưng Biopro', 'vat_pham', 0.0, NULL, 'https://s.shopee.vn/3B5P6t0T4d', NULL, 'Không gian sống trong lành, sạch mát để bảo vệ sức khỏe của bé cưng lẫn cô/chú thương yêu.'),
