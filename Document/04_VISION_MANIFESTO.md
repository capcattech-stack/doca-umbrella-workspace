...
```mermaid
graph TD
    P1[Cột Trụ 1: Cá Nhân Hóa Độc Bản <br> <i>Dynamic Persona</i>]
    P2[Cột Trụ 2: Bộ Nhớ Ký Ức Đồng Hành <br> <i>Shared Memory Core</i>]
    P3[Cột Trụ 3: Tương Tác Biến Thiên <br> <i>Variable Sarcasm & Dopamine</i>]
    P4[Cột Trụ 4: Tích Lũy Cảm Xúc <br> <i>Emotional Investment</i>]
    
    P1 --> Capcat((Capcat: Soul of Pet))
    P2 --> Capcat
    P3 --> Capcat
    P4 --> Capcat

    style Capcat fill:#ffeb3b,stroke:#fbc02d,stroke-width:3px
