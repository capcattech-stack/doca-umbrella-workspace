# Feature Specification: Project Planning - Coin System and ZaloPay MoMo Integration

> Feature ID: `017-project-planning-coin-system-and-zalopay-momo-integration`
> Created: `2026-08-02`
> Status: Draft
> Source Prompt: xây dựng 1 cơ chế quản lý xu mua xu bằng momo/zalopay, quy hoạch thư mục code, đối soát và tự động hóa thuế kế toán
